...
class Rdkit < Formula
  ...
  url "https://github.com/rdkit/rdkit/archive/Release_2018_03_3.tar.gz"
  sha256 "f8577a8f46dcc140acf3bcd3a2f50ba3e1a333d0f24b52d63832c96754b2bb1f"
  ...
  def install
    ...
    args << "-DBOOST_INCLUDEDIR='/usr/local/Cellar/boost@1.66/1.66.0/include'"
    args << "-DBOOST_LIBRARYDIR='/usr/local/Cellar/boost@1.66/1.66.0/lib'"
